...
jogadores = [name for _,name,_ in pkgutil.iter_modules(['estrategias2'])]
...
class Torneio(object):
    ...
    def inicializa_jogadores(self, comida=300.0):
        self.jogadores = {x : importlib.import_module("estrategias2.{}".format(x)).MeuJogador() for x in jogadores}
